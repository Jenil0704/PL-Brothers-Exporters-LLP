...
const Products = () => {
    ...
    return (
        <div className="pt-36 w-full bg-[#FAFAFA] text-black">
            ...
            <div className="pb-16">
                ...
                <div key={category} className="mt-16 px-4 sm:px-6 md:px-12 lg:px-12">
                    <h1 className="categories-heading text-[6.5vw] sm:text-[5.5vw] md:text-[3.5vw] lg:text-[2.2vw] font-medium capitalize">{category} Products</h1>
                            ...
                            {products.map((product) => (
                                <div key={product.id} className="bg-white rounded-xl shadow-md overflow-hidden transition-transform hover:scale-105">
                                    <div className="h-48 overflow-hidden">
                                        <img loading="lazy" src={product.image} alt={product.title} className="w-full h-full object-cover" />
                                    </div>
                                    <div className="p-4">
