        ...
        <div id='contact' className='contact w-full overflow-x-hidden bg-gradient-to-tr from-zinc-900 to-[#0b3238]'>
            <div className='px-4 sm:px-6 md:px-12 lg:px-12 py-12 text-white flex flex-col sm:flex-col md:flex-row lg:flex-row items-start gap-14'>
                ...
                <div className='w-full sm:w-full md:w-1/2 lg:w-1/2 h-full'>
                    <div className='w-full'>
                        <h2 id='lefttext'
                        className='categories-heading lefttext text-[10vw] sm:text-[8.5vw] md:text-[4.5vw] lg:text-[3vw] font-bold'>Get in Touch.</h2>
                ...
                <div className=' w-full sm:w-full md:w-1/2 lg:w-1/2 h-full flex flex-col lg:flex-row gap-10 sm:gap-10 md:gap-5 lg:gap-16'>
                    ...
                    <div className='mt-5 flex flex-col gap-2'>
                        <h1 id='lefttext'
                        className='categories-heading text-[6.5vw] sm:text-[4vw] md:text-[2.8vw] lg:text-[2.5vw] xl:text-[1.8vw] font-bold'>Quick Links</h1>
                    ...
                    <div className='mt-5 flex flex-col gap-2'>
                        <h1 id='lefttext'
                        className='categories-heading text-[6.5vw] sm:text-[4vw] md:text-[2.8vw] lg:text-[2.5vw] xl:text-[1.8vw] font-bold'>Products</h1>
                        <div className='mt-2 flex flex-col gap-2'>
                            {quickLinks.map((link) => (
                                <div key={link.id} id='lefttext'>
                    ...
                    <div className='mt-5 flex flex-col gap-2'>
                        <h1 id='lefttext'
                        className='categories-heading text-[6.5vw] sm:text-[4vw] md:text-[2.8vw] lg:text-[2.5vw] xl:text-[1.8vw] font-bold'>Social Media</h1>
            ...
            <div className=' mt-7 sm:mt-7 md:mt-10 lg:mt-10 py-5 w-full border-t-[1px] border-gray-600 px-12 text-white'>
                <div className='w-full text-center'>
                    <h1 id='lefttext'
                    className='categories-subtext text-[2.6vw] sm:text-[2.6vw] md:text-[1.2vw] lg:text-[1.2vw]'>Copyright 2025 PL Brothers Exporters LLP. All Rights Reserved</h1>
                </div>
            </div>
        </div>
